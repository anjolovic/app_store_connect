...
module AppStoreConnect
  ...
  class CLI
    ...
    COMMANDS = %w[
      ...
      sub-details sub-metadata-status sub-ensure-assets sub-groups sub-group-submissions submit-sub-group sub-group-localizations
      create-sub create-subscription fix-sub-metadata
