...
Gem::Specification.new do |spec|
  ...
  spec.description   = "A Ruby library and command-line tool for interacting with Apple's App Store Connect API. Check app status, review submissions, manage subscriptions, and respond to Apple Review requests."
